...
public static class XmlSignatureConstants
{
    ...
    public readonly struct Nodes
    {
        ...
        public const string DocumentSignatures = "document-signatures";
    }
    ...
    public readonly struct Attributes
    {
        ...
        public const string DefaultNamespace = "xmlns";
    ...
    {
        public const string OpenDocumentSignature = "urn:oasis:names:tc:opendocument:xmlns:digitalsignature:1.0";
    }
    ...
    public readonly struct Uris
    {
        ...
        public const string OpenDocumentReferenceType = "http://docs.oasis-open.org/office/v1.2/OS/OpenDocument-v1.2.odt";
    }
    ...
    public readonly struct EntryFullNames
    {
        ...
        public const string SignaturesOriginRelationships = "_xmlsignatures/_rels/origin.sigs.rels";
        public const string OpenDocumentSignaturesEntry = "META-INF/documentsignatures.xml";
    }
